...
namespace Fathcore.EntityFramework.Tests.Extensions
{
    public class RepositoryExtensionsTest
    {
        ...
        {
            var options = TestHelper.OptionsWithData("TableQueryableAsync_AsTracking", provider);
        ...
        {
            var options = TestHelper.OptionsWithData("TableQueryableAsync_AsNoTracking", provider);
            using (var context = new TestDbContext(options))
            {
                var repository = new Repository<Classroom>(context);
        ...
        {
            var options = TestHelper.OptionsWithData("TableQueryableAsync_Default_EnabledQueryFilter", provider);
        ...
        {
            var options = TestHelper.OptionsWithData("TableQueryableAsync_IgnoreQueryFilter", provider);
            var auditHandler = new AuditHandler(TestHelper.HttpContextAccessor);
            int totalBefore;
        ...
        {
            var options = TestHelper.OptionsWithData("SelectListAsync_ShouldPass", provider);
            using (var context = new TestDbContext(options))
            {
                var repository = new Repository<Classroom>(context);
        ...
        {
            var options = TestHelper.OptionsWithData("SelectListAsync_WithLambda_NavigationProperty_ShouldPass", provider);
            using (var context = new TestDbContext(options))
            {
                var repository = new Repository<Classroom>(context);
        ...
        {
            var options = TestHelper.OptionsWithData("SelectListAsync_WithString_NavigationProperty_ShouldPass", provider);
            using (var context = new TestDbContext(options))
            {
                var repository = new Repository<Classroom>(context);
        ...
        {
            var options = TestHelper.OptionsWithData("SelectListAsync_MatchesPredicate_WithoutNavigationProperty_ShouldPass", provider);
        ...
        {
            var options = TestHelper.OptionsWithData("SelectListAsync_MatchesPredicate_WithLambda_NavigationProperty_ShouldPass", provider);
            var entity = FakeEntityGenerator.Classrooms.First();
            using (var context = new TestDbContext(options))
            {
                var repository = new Repository<Classroom>(context);
        ...
        {
            var options = TestHelper.OptionsWithData("SelectListAsync_MatchesPredicate_WithString_NavigationProperty_ShouldPass", provider);
            var entity = FakeEntityGenerator.Classrooms.First();
            using (var context = new TestDbContext(options))
            {
                var repository = new Repository<Classroom>(context);
        ...
        {
            var options = TestHelper.OptionsWithData("SelectAsync_MatchesPredicate_WithoutNavigationProperty_ShouldPass", provider);
            var entity = FakeEntityGenerator.Classrooms.First();
            using (var context = new TestDbContext(options))
            {
                var repository = new Repository<Classroom>(context);
        ...
        {
            var options = TestHelper.OptionsWithData("SelectAsync_MatchesPredicate_WithLambda_NavigationProperty_ShouldPass", provider);
            var entity = FakeEntityGenerator.Classrooms.First();
            using (var context = new TestDbContext(options))
            {
                var repository = new Repository<Classroom>(context);
        ...
        {
            var options = TestHelper.OptionsWithData("SelectAsync_MatchesPredicate_WithString_NavigationProperty_ShouldPass", provider);
            var entity = FakeEntityGenerator.Classrooms.First();
            using (var context = new TestDbContext(options))
            {
                var repository = new Repository<Classroom>(context);
        ...
        {
            var options = TestHelper.Options("SelectAsync_MatchesPrimaryKey_SafetyCheck", provider);
        ...
        {
            var options = TestHelper.OptionsWithData("SelectAsync_MatchesPrimaryKey_ShouldPass", provider);
            Classroom entity;
        ...
        {
            var options = TestHelper.Options("InsertAsync_Entity_SafetyCheck", provider);
        ...
        {
            var options = TestHelper.Options("InsertAsync_Entity_ShouldPass", provider);
        ...
        {
            var options = TestHelper.Options("InsertAsync_Entities_SafetyCheck", provider);
        ...
        {
            var options = TestHelper.Options("InsertAsync_Entities_ShouldPass", provider);
        ...
        {
            var options = TestHelper.OptionsWithData("UpdateAsync_Entity_SafetyCheck", provider);
            Classroom entity = default;
        ...
        {
            var options = TestHelper.OptionsWithData("UpdateAsync_Entity_ShouldPass", provider);
            Classroom entity;
        ...
        {
            var options = TestHelper.OptionsWithData("UpdateAsync_Entities_SafetyCheck", provider);
            IEnumerable<Classroom> entities = default;
        ...
        {
            var options = TestHelper.OptionsWithData("UpdateAsync_Entities_ShouldPass", provider);
        ...
        {
            var options = TestHelper.OptionsWithData("DeleteAsync_Entity_SafetyCheck", provider);
            Classroom entity = default;
        ...
        {
            var options = TestHelper.OptionsWithData("DeleteAsync_Entity_ShouldPass", provider);
            Classroom entity;
        ...
        {
            var options = TestHelper.OptionsWithData("DeleteAsync_Entity_ByPrimaryKey_SafetyCheck", provider);
        ...
        {
            var options = TestHelper.OptionsWithData("DeleteAsync_Entity_ByPrimaryKey_ShouldPass", provider);
            int keyValue;
        ...
        {
            var options = TestHelper.OptionsWithData("DeleteAsync_Entities_SafetyCheck", provider);
            IEnumerable<Classroom> entities = default;
        ...
        {
            var options = TestHelper.OptionsWithData("DeleteAsync_Entities_ShouldPass", provider);
            IEnumerable<Classroom> entities = default;
        ...
        {
            var options = TestHelper.OptionsWithData("SaveChangesAsync_AsTracking_ShouldPass", provider);
            Classroom entity;
            string modified = "Modified";
        ...
        {
            var options = TestHelper.OptionsWithData("SaveChangesAsync_AsNoTracking_ShouldPass", provider);
            Classroom entity;
            string modified = "Modified";
        ...
        {
            var options = TestHelper.OptionsWithData("SaveChangesAsync_AsNoTracking_Disconnected_ShouldPass", provider);
            Classroom entity;
            string modified = "Modified";
        ...
        {
            var options = TestHelper.OptionsWithData("SaveChangesAsync_AsNoTracking_ShouldNotSaved", provider);
            Classroom entity;
            string modified = "Modified";
        ...
        {
            var options = TestHelper.OptionsWithData("SaveChangesAsync_ShouldRollbackEntityChanges", provider);
            Classroom entity;
