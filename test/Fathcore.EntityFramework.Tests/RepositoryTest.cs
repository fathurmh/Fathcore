...
namespace Fathcore.EntityFramework.Tests
{
    public class RepositoryTest
    {
        ...
        {
            var options = TestHelper.Options("AsTracking_ShouldChange_QueryTrackingBehavior", provider);
            using (var context = new TestDbContext(options))
            {
                var repository = new Repository<Classroom>(context);
        ...
        {
            var options = TestHelper.Options("AsNoTracking_ShouldChange_QueryTrackingBehavior", provider);
            using (var context = new TestDbContext(options))
            {
                var repository = new Repository<Classroom>(context);
        ...
        {
            var options = TestHelper.Options("Tracking_ShouldChange_QueryTrackingBehavior", provider);
            using (var context = new TestDbContext(options))
            {
                var repository = new Repository<Classroom>(context);
        ...
        {
            var options = TestHelper.OptionsWithData("TableQueryable_AsTracking", provider);
            using (var context = new TestDbContext(options))
            {
                var repository = new Repository<Classroom>(context);
        ...
        {
            var options = TestHelper.OptionsWithData("TableQueryable_AsNoTracking", provider);
            using (var context = new TestDbContext(options))
            {
                var repository = new Repository<Classroom>(context);
                repository.AsNoTracking();
        ...
        {
            var options = TestHelper.OptionsWithData("TableQueryable_Default_EnabledQueryFilter", provider);
        ...
        {
            var options = TestHelper.OptionsWithData("TableQueryable_Default_AsFiltered", provider);
            var auditHandler = new AuditHandler(TestHelper.HttpContextAccessor);
            int totalBefore;
        ...
        {
            var options = TestHelper.OptionsWithData("SelectList_ShouldPass", provider);
            using (var context = new TestDbContext(options))
            {
                var repository = new Repository<Classroom>(context);
        ...
        {
            var options = TestHelper.OptionsWithData("SelectList_WithLambda_NavigationProperty_ShouldPass", provider);
            using (var context = new TestDbContext(options))
            {
                var repository = new Repository<Classroom>(context);
        ...
        {
            var options = TestHelper.OptionsWithData("SelectList_WithString_NavigationProperty_ShouldPass", provider);
            using (var context = new TestDbContext(options))
            {
                var repository = new Repository<Classroom>(context);
        ...
        {
            var options = TestHelper.OptionsWithData("SelectList_MatchesPredicate_WithoutNavigationProperty_ShouldPass", provider);
        ...
        {
            var options = TestHelper.OptionsWithData("SelectList_MatchesPredicate_WithLambda_NavigationProperty_ShouldPass", provider);
            var entity = FakeEntityGenerator.Classrooms.First();
            using (var context = new TestDbContext(options))
            {
                var repository = new Repository<Classroom>(context);
        ...
        {
            var options = TestHelper.OptionsWithData("SelectList_MatchesPredicate_WithString_NavigationProperty_ShouldPass", provider);
            var entity = FakeEntityGenerator.Classrooms.First();
            using (var context = new TestDbContext(options))
            {
                var repository = new Repository<Classroom>(context);
        ...
        {
            var options = TestHelper.OptionsWithData("Select_MatchesPredicate_WithoutNavigationProperty_ShouldPass", provider);
            var entity = FakeEntityGenerator.Classrooms.First();
            using (var context = new TestDbContext(options))
            {
                var repository = new Repository<Classroom>(context);
        ...
        {
            var options = TestHelper.OptionsWithData("Select_MatchesPredicate_WithLambda_NavigationProperty_ShouldPass", provider);
            var entity = FakeEntityGenerator.Classrooms.First();
            using (var context = new TestDbContext(options))
            {
                var repository = new Repository<Classroom>(context);
        ...
        {
            var options = TestHelper.OptionsWithData("Select_MatchesPredicate_WithString_NavigationProperty_ShouldPass", provider);
            var entity = FakeEntityGenerator.Classrooms.First();
            using (var context = new TestDbContext(options))
            {
                var repository = new Repository<Classroom>(context);
        ...
        {
            var options = TestHelper.Options("Select_MatchesPrimaryKey_SafetyCheck", provider);
        ...
        {
            var options = TestHelper.OptionsWithData("Select_MatchesPrimaryKey_ShouldPass", provider);
            Classroom entity;
        ...
        {
            var options = TestHelper.Options("Insert_Entity_SafetyCheck", provider);
        ...
        {
            var options = TestHelper.Options("Insert_Entity_ShouldPass", provider);
        ...
        {
            var options = TestHelper.Options("Insert_Entities_SafetyCheck", provider);
        ...
        {
            var options = TestHelper.Options("Insert_Entities_ShouldPass", provider);
        ...
        {
            var options = TestHelper.OptionsWithData("Update_Entity_SafetyCheck", provider);
            Classroom entity = default;
        ...
        {
            var options = TestHelper.OptionsWithData("Update_Entity_ShouldPass", provider);
            Classroom entity;
        ...
        {
            var options = TestHelper.OptionsWithData("Update_Entities_SafetyCheck", provider);
            IEnumerable<Classroom> entities = default;
        ...
        {
            var options = TestHelper.OptionsWithData("Update_Entities_ShouldPass", provider);
        ...
        {
            var options = TestHelper.OptionsWithData("Delete_Entity_SafetyCheck", provider);
            Classroom entity = default;
        ...
        {
            var options = TestHelper.OptionsWithData("Delete_Entity_ShouldPass", provider);
            Classroom entity;
        ...
        {
            var options = TestHelper.OptionsWithData("Delete_Entity_ByPrimaryKey_SafetyCheck", provider);
        ...
        {
            var options = TestHelper.OptionsWithData("Delete_Entity_ByPrimaryKey_ShouldPass", provider);
            int keyValue;
        ...
        {
            var options = TestHelper.OptionsWithData("Delete_Entities_SafetyCheck", provider);
            IEnumerable<Classroom> entities = default;
        ...
        {
            var options = TestHelper.OptionsWithData("Delete_Entities_ShouldPass", provider);
            IEnumerable<Classroom> entities = default;
        ...
        {
            var options = TestHelper.OptionsWithData("SaveChanges_AsTracking_ShouldPass", provider);
            Classroom entity;
            string modified = "Modified";
        ...
        {
            var options = TestHelper.OptionsWithData("SaveChanges_AsNoTracking_ShouldPass", provider);
            Classroom entity;
            string modified = "Modified";
        ...
        {
            var options = TestHelper.OptionsWithData("SaveChanges_AsNoTracking_Disconnected_ShouldPass", provider);
            Classroom entity;
            string modified = "Modified";
        ...
        {
            var options = TestHelper.OptionsWithData("SaveChanges_AsNoTracking_ShouldNotSaved", provider);
            Classroom entity;
            string modified = "Modified";
        ...
        {
            var options = TestHelper.OptionsWithData("SaveChanges_ShouldRollbackEntityChanges", provider);
            Classroom entity;
