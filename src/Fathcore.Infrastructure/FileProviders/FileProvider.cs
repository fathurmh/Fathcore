...
namespace Fathcore.Infrastructure.FileProviders
{
    /// <summary>
    ...
    public class FileProvider : PhysicalFileProvider, IFileProvider
    {
        ...
        /// <summary>
        /// Initializes a new instance of a <see cref="FileProvider"/>.
        /// </summary>
        ...
        {
            return !FileExists(path) ? -1 : new FileInfo(path).Length;
        }
        ...
        /// <returns>
        /// A <see cref="DateTime"/> structure set to the creation date and time for the specified file or directory. This value is expressed in local time.</returns>
        ...
        /// <returns>Directory information for path, or null if path denotes a root directory or is null. Returns <see cref="string.Empty"/> if path does not contain directory information.</returns>
        ...
        /// <returns>A <see cref="DateTime"/> structure set to the date and time that the specified file.</returns>
