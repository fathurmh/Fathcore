...
namespace Fathcore.EntityFramework
{
        ...
        where TEntity : BaseEntity<TEntity>, IBaseEntity
    {
        ...
        /// <returns>The entities found, or zero collection.</returns>
        IPagedList<TEntity> PagedList(int pageIndex, int pageSize);
        ...
        /// <param name="navigationProperties">A lambda expression representing the navigation property to be included (t => t.Property1).</param>
        /// <returns>The entities found, or zero collection.</returns>
        IPagedList<TEntity> PagedList(int pageIndex, int pageSize, params Expression<Func<TEntity, object>>[] navigationProperties);
        ...
        /// <param name="navigationProperties">A string representing the navigation property to be included ("Property1").</param>
        /// <returns>The entities found, or zero collection.</returns>
        IPagedList<TEntity> PagedList(int pageIndex, int pageSize, params string[] navigationProperties);
        ...
        /// <param name="pageSize">Sets the page size contained in the <see cref="IPagedList{T}"/>.</param>
        /// <returns>The entities found that contains elements from the input sequence that satisfy the condition specified by predicate predicate, or zero collection.</returns>
        IPagedList<TEntity> PagedList(Expression<Func<TEntity, bool>> predicate, int pageIndex, int pageSize);
        ...
        /// <param name="navigationProperties">A lambda expression representing the navigation property to be included (t => t.Property1).</param>
        /// <returns>The entities found that contains elements from the input sequence that satisfy the condition specified by predicate predicate, or zero collection.</returns>
        IPagedList<TEntity> PagedList(Expression<Func<TEntity, bool>> predicate, int pageIndex, int pageSize, params Expression<Func<TEntity, object>>[] navigationProperties);
        ...
        /// <param name="navigationProperties">A string representing the navigation property to be included ("Property1").</param>
        /// <returns>The entities found that contains elements from the input sequence that satisfy the condition specified by predicate predicate, or zero collection.</returns>
        IPagedList<TEntity> PagedList(Expression<Func<TEntity, bool>> predicate, int pageIndex, int pageSize, params string[] navigationProperties);
