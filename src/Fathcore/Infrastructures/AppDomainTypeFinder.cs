...
namespace Fathcore.Infrastructures
{
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        protected ICoreFileProvider _fileProvider;
        
        /// <summary>The app domain to look for types in.</summary>
        public virtual AppDomain App => AppDomain.CurrentDomain;

        /// <summary>Gets or sets whether Core should iterate assemblies in the app domain when loading Core types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// </param>
        /// <returns>
        /// True if the assembly should be loaded into Core.
        /// </returns>
